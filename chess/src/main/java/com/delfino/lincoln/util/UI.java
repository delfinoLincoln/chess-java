package com.delfino.lincoln.util;
...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> capturedPiece) {
        List<ChessPiece> white = capturedPiece.stream().filter(x -> x.getColor() == Color.WHITE)
                .collect(Collectors.toList());
        List<ChessPiece> black = capturedPiece.stream().filter(x -> x.getColor() == Color.BLACK)
                .collect(Collectors.toList());
